  ...
  return (
    ...
    >
      ...
      <p>
        ...
        conditions. Do not continue to use Bookshlf if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Bookshlf, you agreed to use
      ...
      <p>
        Unless otherwise stated, Bookshlf and/or its licensors own the
        intellectual property rights for all material on Bookshlf. All
        intellectual property rights are reserved. You may access this from
        Bookshlf for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Bookshlf</li>
        <li>Sell, rent or sub-license material from Bookshlf</li>
        <li>Reproduce, duplicate or copy material from Bookshlf</li>
        <li>Redistribute content from Bookshlf</li>
      </ul>
      <p>
      ...
      <p>
        ...
        Bookshlf does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Bookshlf,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Bookshlf shall not be liable
      ...
      <p>
        Bookshlf reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Bookshlf a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Bookshlf; and (d) the link is
      ...
      <p>
        ...
        e-mail to Bookshlf. Please include your name, your organization name,
      ...
      <p>
        No use of Bookshlf's logo or other artwork will be allowed for linking
