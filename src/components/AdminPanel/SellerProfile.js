      ...
      <Stack direction="column" spacing={2}>
        ...
        >
          <Stack direction="row" spacing={2} alignItems="center">
            <p>Books Sold :</p>
            <Fab color="primary" aria-label="Total Books Sold" size="small">
              {sellerData.noOfBooksSold}
            </Fab>
          </Stack>
          <Stack direction="row" spacing={2} alignItems="center">
            <p>Total Ratings Recieved : </p>
            <Fab color="primary" aria-label="Total Books Sold" size="small">
              {sellerData.noOfRatings}
            </Fab>
          </Stack>
          <Stack direction="row" spacing={2} alignItems="center">
            <p>Total Reviews Recieved :</p>
            <Fab color="primary" aria-label="Total Books Sold" size="small">
        ...
        <Stack direction="row" spacing={2}>
          <UpdateIcon />
          <p>Last Updated : </p>
          <p>{sellerData?.updatedAt?.substr(0, 10)}</p>
        </Stack>
        <Stack direction="row" spacing={2}>
          <TimeIcon />
          <p>Joined : </p>
          <p>{sellerData?.createdAt?.substr(0, 10)}</p>
        </Stack>
      </Stack>
    </Box>
  );
