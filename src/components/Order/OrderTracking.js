      ...
      {!load ? (
        <Stack direction="column" spacing={3} sx={{ padding: "10px" }}>
          ...
          <Stack direction="column" spacing={2} alignItems="center">
            ...
            />
            <List
              subheader={<ListSubheader>Book Details</ListSubheader>}
              sx={{ width: "100%" }}
            >
              <ListItem disablePadding>
                <ListItemIcon>
                ...
                <ListItemText primary="Book ID" secondary={order.bookId} />
              </ListItem>
              <Divider />
              <ListItem disablePadding>
                <ListItemIcon>
                ...
                <ListItemText primary="Book Name" secondary={order.title} />
              </ListItem>
              <Divider />
              <ListItem disablePadding>
                <ListItemIcon>
                ...
                <ListItemText primary="Book Author" secondary={order.author} />
              </ListItem>
              <Divider />
              <ListItem disablePadding>
                <ListItemIcon>
            ...
            {/* ================================================= */}
            <List
              subheader={<ListSubheader>Customer Details</ListSubheader>}
              sx={{ width: "100%" }}
            >
              <ListItem disablePadding>
                <ListItemIcon>
            ...
            <List
              subheader={<ListSubheader>Customer Address</ListSubheader>}
              sx={{ width: "100%" }}
            >
              <ListItem disablePadding>
                <ListItemIcon>
            ...
            {/* ============================================================= */}
            <List
              subheader={<ListSubheader>Payment Details</ListSubheader>}
              sx={{ width: "100%" }}
            >
              <ListItem disablePadding>
                <ListItemButton>
