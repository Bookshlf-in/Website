          ...
          <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
            ...
            >
              <Tab
                iconPosition="top"
                label="Profile"
                icon={<ProfileIcon sx={{ height: 12, width: 12 }} />}
                value="1"
                sx={TabStyle}
              />
              <Tab
                iconPosition="top"
                label="Books"
                icon={<OrderIcon sx={{ height: 12, width: 12 }} />}
                value="2"
                sx={TabStyle}
              />
              <Tab
                iconPosition="top"
                label="Address"
                icon={<SellersIcon sx={{ height: 12, width: 12 }} />}
                value="3"
                sx={TabStyle}
              />
              <Tab
                iconPosition="top"
                label="Reviews"
                icon={<ReviewIcon sx={{ height: 12, width: 12 }} />}
                value="4"
                sx={TabStyle}
              />
              <Tab
                iconPosition="top"
                label="Add Book"
                icon={<BookIcon sx={{ height: 12, width: 12 }} />}
                value="5"
                sx={TabStyle}
              />
            </TabList>
          </Box>
          <TabPanel value="1" sx={{ padding: "10px 5px" }}>
            <AccountDetails seller={sellerDetails} panel={panel} />
          </TabPanel>
          <TabPanel value="2" sx={{ padding: "10px 5px" }}>
            <Orders address={Adr} panel={panel} />
          </TabPanel>
          <TabPanel value="3" sx={{ padding: "10px 5px" }}>
            <Address address={Adr} panel={panel} />
          </TabPanel>
          <TabPanel value="4" sx={{ padding: "10px 5px" }}>
            <Reviews reviews={sellerReview} sellerId={sellerId} panel={panel} />
          </TabPanel>
          <TabPanel value="5" sx={{ padding: "10px 5px" }}>
            <AddBook
              address={Adr}
