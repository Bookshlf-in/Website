            ...
            <View style={styles.pagebox}>
                ...
                <View style={styles.detailsstyling}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Image src ="https://img.bookshlf.in/logo/smallLogo.png" style={styles.BookPhoto} />
                ...
                <View style={styles.customerDetails}>
                    ...
                    <View style={styles.detailsstyling}>
                        ...
                        <Text style={styles.AfterColonText}>{details.orderDetails.customerName}</Text>
                    </View>
                    <View style={styles.detailsstyling}>
                        <Text style={styles.BeforeColonText}>Delivery Address : </Text>
                        <Text style={styles.AfterColonText}>{details.orderDetails.customerAddress['address']},
                    ...
                    <View style={styles.detailsstyling}>
                        ...
                        <Text style={styles.AfterColonText}>{details.orderDetails.customerAddress['phoneNo']}</Text>
                    </View>
                </View>
                <View style={styles.customerDetails}>
                    ...
                    <View style={styles.detailsstyling}>
                        ...
                        <Text style={styles.AfterColonText}>{details.orderDetails.title}</Text>
                    </View>
                    <View style={styles.detailsstyling}>
                        <Text style={styles.BeforeColonText}>Author : </Text>
                        <Text style={styles.AfterColonText}>{details.orderDetails.author}</Text>
                    </View>
                    <View style={styles.detailsstyling}>
                        <Text style={styles.BeforeColonText}>Seller Name : </Text>
                        <Text style={styles.AfterColonText}>{details.orderDetails.sellerName}</Text>
                    </View>
                ...
                <View style={styles.customerDetails}>
                    ...
                    <View style={styles.detailsstyling}>
                        ...
                        <Text style={styles.AfterColonText}>{details.orderDetails.price}</Text>
                    </View>
                    <View style={styles.detailsstyling}>
                        <Text style={styles.BeforeColonText}>Quantity : </Text>
                        <Text style={styles.AfterColonText}>{details.orderDetails.purchaseQty}</Text>
                    </View>
                    <View style={styles.detailsstyling}>
                        <Text style={styles.BeforeColonText}>Shipping Charges : </Text>
                        <Text style={styles.AfterColonText}>{details.orderDetails.shippingCharges}</Text>
                    </View>
                    <View style={styles.detailsstyling}>
                        <Text style={styles.BeforeColonText}>Total Amount : </Text>
                        <Text style={styles.AfterColonText}>{details.orderDetails.orderTotal}</Text>
                    </View>
                </View>
